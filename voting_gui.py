...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.poll_image.setGeometry(QtCore.QRect(100, -40, 271, 241))
        ...
        self.poll_items = QtWidgets.QButtonGroup(MainWindow)
        self.poll_items.setObjectName("poll_items")
        self.poll_items.setExclusive(False)
        self.poll_items.addButton(self.christmas_button)
        ...
        self.poll_items.addButton(self.halloween_button)
        ...
        self.poll_items.addButton(self.summer_button)
        ...
        self.poll_items.addButton(self.winter_button)
