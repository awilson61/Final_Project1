...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.halloween_image.setPixmap(QtGui.QPixmap("halloween-pumpkin-with-hat-free-svg-file.png"))
        ...
        self.christmas_image.setPixmap(QtGui.QPixmap("221206-F-FD430-0009.PNG.png"))
